...
> Calculate the [variance][variance] of a one-dimensional double-precision floating-point ndarray, ignoring `NaN` values.
...
<!-- <div class="equation" align="center" data-raw-text="\bar{x} = \frac{1}{n} \sum_{i=0}^{n-1} x_i" data-equation="eq:sample_mean">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@7a5c49ad1110e3d36adadf13df15e155a66c4a0c/lib/node_modules/@stdlib/stats/base/ndarray/dnanvariance/docs/img/equation_sample_mean.svg" alt="Equation for the sample mean.">
    <br>
</div> -->
...
Computes the [variance][variance] of a one-dimensional double-precision floating-point ndarray, ignoring `NaN` values.
...
-   **arrays**: array-like object containing the following ndarrays:
    ...
    -   a zero-dimensional ndarray specifying the degrees of freedom adjustment. Providing a non-zero degrees of freedom adjustment has the effect of adjusting the divisor during the calculation of the [variance][variance] according to `N-c` where `N` is the number of non-NaN elements in the input ndarray and `c` corresponds to the provided degrees of freedom adjustment. When computing the [variance][variance] of a population, setting this parameter to `0` is the standard choice (i.e., the provided array contains data constituting an entire population). When computing the corrected sample [variance][variance], setting this parameter to `1` is the standard choice (i.e., the provided array contains data sampled from a larger population; this is commonly referred to as Bessel's correction).
...
#### stdlib_stats_dnanvariance( arrays )
...
double v = stdlib_stats_dnanvariance( arrays );
// returns ~4.3333
...
-   **arrays**: `[in] struct ndarray**` list containing the following ndarrays:
    ...
    -   `[in] struct ndarray*` a zero-dimensional ndarray specifying the degrees of freedom adjustment. Providing a non-zero degrees of freedom adjustment has the effect of adjusting the divisor during the calculation of the [variance][variance] according to `N-c` where `N` is the number of non-NaN elements in the input ndarray and `c` corresponds to the provided degrees of freedom adjustment. When computing the [variance][variance] of a population, setting this parameter to `0` is the standard choice (i.e., the provided array contains data constituting an entire population). When computing the corrected sample [variance][variance], setting this parameter to `1` is the standard choice (i.e., the provided array contains data sampled from a larger population; this is commonly referred to as Bessel's correction).
...
int main( void ) {
    ...
    const double data[] = { 1.0, -2.0, 3.0, -4.0, 0.0/0.0, -6.0, 7.0, -8.0 };
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-base-ndarray-dnanvariance.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-base-ndarray-dnanvariance

[test-image]: https://github.com/stdlib-js/stats-base-ndarray-dnanvariance/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/stats-base-ndarray-dnanvariance/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-base-ndarray-dnanvariance/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-base-ndarray-dnanvariance?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-base-ndarray-dnanvariance.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-base-ndarray-dnanvariance/main
...
[deno-url]: https://github.com/stdlib-js/stats-base-ndarray-dnanvariance/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-base-ndarray-dnanvariance/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-base-ndarray-dnanvariance/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-base-ndarray-dnanvariance/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-base-ndarray-dnanvariance/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-base-ndarray-dnanvariance/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-base-ndarray-dnanvariance/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-base-ndarray-dnanvariance/main/LICENSE
